...
using Smart_contracts.Contracts.Starboard721.ContractDefinition;

namespace Smart_contracts.Contracts.Starboard721
{
    public partial class Starboard721Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, Starboard721Deployment starboard721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<Starboard721Deployment>().SendRequestAndWaitForReceiptAsync(starboard721Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, Starboard721Deployment starboard721Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<Starboard721Deployment>().SendRequestAsync(starboard721Deployment);
        }

        public static async Task<Starboard721Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, Starboard721Deployment starboard721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, starboard721Deployment, cancellationTokenSource);
            return new Starboard721Service(web3, receipt.ContractAddress);
        }
        ...
        public Starboard721Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> MintStarboard721RequestAsync(MintStarboard721Function mintStarboard721Function)
        {
             return ContractHandler.SendRequestAsync(mintStarboard721Function);
        }

        public Task<TransactionReceipt> MintStarboard721RequestAndWaitForReceiptAsync(MintStarboard721Function mintStarboard721Function, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(mintStarboard721Function, cancellationToken);
        }

        public Task<string> MintStarboard721RequestAsync(BigInteger num, string tokenURI)
        {
            var mintStarboard721Function = new MintStarboard721Function();
                mintStarboard721Function.Num = num;
                mintStarboard721Function.TokenURI = tokenURI;
            
             return ContractHandler.SendRequestAsync(mintStarboard721Function);
        }

        public Task<TransactionReceipt> MintStarboard721RequestAndWaitForReceiptAsync(BigInteger num, string tokenURI, CancellationTokenSource cancellationToken = null)
        {
            var mintStarboard721Function = new MintStarboard721Function();
                mintStarboard721Function.Num = num;
                mintStarboard721Function.TokenURI = tokenURI;
